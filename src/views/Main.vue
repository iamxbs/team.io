...
<template>
    <div id="main" class="main" :class="{'main-hide-text': hideMenuText}">
        <div class="sidebar-menu-con"
             :style="{width: hideMenuText?'60px':'200px', overflow: hideMenuText ? 'visible' : 'auto', background: $store.state.app.menuTheme === 'dark'?'#495060':'white'}">
            <div class="logo-con">
                <img v-show="!hideMenuText" src="../images/log1.png">
        ...
        <div class="main-header-con" :style="{paddingLeft: hideMenuText?'60px':'200px'}">
            <div class="main-header">
                ...
                <div class="header-avator-con">
                    <!--<div @click="handleFullScreen" v-if="showFullScreenBtn" class="full-screen-btn-con" style="opacity: 1">-->
                        <!--<Tooltip :content="isFullScreen ? '退出全屏' : '全屏'" placement="bottom">-->
                            <!--<Icon :type="isFullScreen ? 'arrow-shrink' : 'arrow-expand'" :size="23"></Icon>-->
                        <!--</Tooltip>-->
                    <!--</div>-->
                    <!--<div @click="lockScreen" class="lock-screen-btn-con" style="opacity: 1">-->
                        <!--<Tooltip content="锁屏" placement="bottom">-->
                            <!--<Icon type="locked" :size="20"></Icon>-->
                        <!--</Tooltip>-->
                    <!--</div>-->
                    <div @click="showMessage" class="message-con" style="opacity: 1">
...
<script>
  import sidebarMenu from './home_components/sidebarMenu.vue';
  import tagsPageOpened from './home_components/tagsPageopened.vue';
  import breadcrumbNav from './home_components/breadcrumbNav.vue';
  import themeDropDownMenu from './home_components/themeDropdownMenu.vue';
  import sidebarMenuShrink from './home_components/sidebarMenuShrink.vue';
  ...
  export default {
    ...
    computed: {
      ...
      tagsList () {
        return this.$store.state.app.tagsList;  // 所有页面的页面对象
      },
      pageTagsList () {
    ...
    methods: {
      init () {
        ...
        this.userName = Cookies.get('realName');
        let messageCount = 3;
    ...
    created () {
      ...
      // 根据用户设置主题
      if (this.$store.state.app.theme !== 'b') {
        let stylesheetPath = './dist/' + this.$store.state.app.theme + '.css';
        let themeLink = document.querySelector('link[name="theme"]');
